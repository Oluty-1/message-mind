...
import MatrixAuth from '@/components/MatrixAuth';
import Dashboard from '@/components/Dashboard';

export default function Home() {
  const [client, setClient] = useState<MessageMindMatrix | null>(null);

  const handleAuthenticated = (authenticatedClient: MessageMindMatrix) => {
    setClient(authenticatedClient);
  };

  if (!client) {
    return <MatrixAuth onAuthenticated={handleAuthenticated} />;
  }
